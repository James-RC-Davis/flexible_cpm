function [behav_pred_pos, behav_pred_neg, behav_pred_combined,...
    ...
    macronets_run_flexible_CPM(all_behav, all_mats, all_covars, k, thresh_type,...
    thresh, adjust_stage, cat_covars, corr_type, macronet_masks)
...
for fold = 1:k
    ...
    [train_sumpos, train_sumneg, train_sumcombined, train_sumpos_macronets, train_sumneg_macronets, train_sumcombined_macronets] = ...
        macronets_CPM_network_strength(train_mats, pos_mask, neg_mask, ix_train, macronet_masks);
    ...
    if strcmp(adjust_stage, 'fit') | strcmp(adjust_stage, 'both')
        ...
        train_sumpos, train_sumneg, adjust_stage, cat_covars);
    else
        [fit_pos, fit_neg, fit_combined] = ...
        macronets_CPM_fit_model(train_behav, [], 0, ...
    ...
    if strcmp(adjust_stage, 'fit') | strcmp(adjust_stage, 'both')
        ...
        [pred_pos, pred_neg, pred_combined] = ...
            macronets_CPM_apply_model(test_mats, [], 0, ...
            pos_mask, neg_mask, fit_pos, fit_neg, fit_combined, macronet_masks);
    end
