function [perm_p_pos, perm_p_neg, perm_p_combined] = ...
    macronets_CPM_permutation_test(all_behav, all_mats, all_covars, k, thresh_type, thresh, ...
    adjust_stage, true_r_pos, true_r_neg, true_r_combined, n_iterations, cat_covars, corr_type, macronet_masks)
...
% Permute CPM
    parfor i = 1:n_iterations
        ...
        [behav_pred_pos, behav_pred_neg, behav_pred_combined,...
            ~, ~, ~, ~, ~, ~, ~] = macronets_run_flexible_CPM(...
            random_behav, all_mats, all_covars, k, thresh_type, thresh, adjust_stage, cat_covars, corr_type, macronet_masks);
